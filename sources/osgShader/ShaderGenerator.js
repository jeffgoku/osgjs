...
ShaderGenerator.prototype = {
    ...
    getOrCreateProgram: ( function () {
        ...
        return function ( state ) {
            ...
            var name;
            name = shaderGen.getFragmentShaderName();
            if ( !name ) name = shaderGen.getVertexShaderName();
            if ( name === 'CompilerOSGJS' ) name += '_' + hash;

            var program = ShaderProgramBuilder.createProgram( vertexShader, fragmentShader, name );
